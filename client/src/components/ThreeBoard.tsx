  ...
  return (
    <group rotation={[0, 0, 0]}>
      <mesh position={[0, 0.9, 0]}>
        <coneGeometry args={[0.45, 1.0, 16]} />
        <meshStandardMaterial color="#ffffff" metalness={0.6} roughness={0.2} emissive="#222222" />
      </mesh>
      <mesh position={[0, 0.35, 0]}> 
        <cylinderGeometry args={[0.28, 0.28, 0.9, 16]} />
        <meshStandardMaterial color="#d94f2b" metalness={0.6} roughness={0.25} emissive="#220800" />
      </mesh>
      <mesh position={[0.35, 0.05, 0.25]} rotation={[0, 0, 0.6]}> 
        <boxGeometry args={[0.18, 0.02, 0.5]} />
        <meshStandardMaterial color="#a02b1a" metalness={0.6} roughness={0.3} />
      </mesh>
      <mesh position={[-0.35, 0.05, 0.25]} rotation={[0, 0, -0.6]}> 
        <boxGeometry args={[0.18, 0.02, 0.5]} />
        <meshStandardMaterial color="#a02b1a" metalness={0.6} roughness={0.3} />
      ...
      <mesh position={[0, -0.1, 0]}> 
        <cylinderGeometry args={[0.12, 0.12, 0.18, 12]} />
        <meshStandardMaterial color="#333" metalness={1} roughness={0.1} emissive="#332200" />
      </mesh>
    </group>
  )
}
...
function Planet({ variant }: { variant: number | null }) {
  ...
  return (
    <group position={[0, 0.6, 0]}>
      <mesh>
        <sphereGeometry args={[0.9, 32, 32]} />
        <meshStandardMaterial color={color} metalness={0.3} roughness={0.4} emissive={accent} />
      </mesh>
      {variant === 1 && (
        <mesh rotation={[Math.PI / 2, 0, 0]}> 
          <torusGeometry args={[1.2, 0.08, 16, 60]} />
          <meshStandardMaterial color="#cfa87f" metalness={0.4} roughness={0.6} emissive="#442200" />
        </mesh>
      )}
    </group>
  )
